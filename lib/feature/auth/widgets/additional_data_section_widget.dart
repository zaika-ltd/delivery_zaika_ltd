...
class AdditionalDataSectionWidget extends StatelessWidget {
  ...
  List<String> cardSide=['Front Side','Back Side',''];
   AdditionalDataSectionWidget({super.key, required this.authController, required this.scrollController});
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          child: showTextField ? CustomTextFieldWidget(
            ...
            Text(
              authController.camelToSentence(authController.dataList![index].inputData!),
              style: robotoMedium,
            ),
            ...
            Text(authController.camelToSentence(authController.dataList![index].inputData!), style: robotoMedium),
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.add, size: 50, color: Theme.of(context).disabledColor),
                          Text(cardSide[i], style: robotoMedium.copyWith(color: Theme.of(context).disabledColor)),
