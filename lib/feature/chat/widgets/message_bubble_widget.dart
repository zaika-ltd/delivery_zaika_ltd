...
import 'package:stackfood_multivendor_driver/feature/chat/widgets/chat_video_view.dart';
import 'package:stackfood_multivendor_driver/feature/chat/widgets/image_file_view_widget.dart';
import 'package:stackfood_multivendor_driver/feature/chat/widgets/pdf_view_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Column(crossAxisAlignment: isRightMessage ? CrossAxisAlignment.end : CrossAxisAlignment.start , children: [
        ...
        Padding(
          padding: isRightMessage ? EdgeInsets.fromLTRB(20, (currentMessage.message != null && isSameUserWithNextMessage) ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeDefault, Dimensions.paddingSizeSmall,
          ...
          child: Column(crossAxisAlignment: isRightMessage ? CrossAxisAlignment.end : CrossAxisAlignment.start, children: [
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, mainAxisAlignment: isRightMessage ? MainAxisAlignment.end : MainAxisAlignment.start, children: [
              ...
              isRightMessage ? const SizedBox() : (!isRightMessage && !isSameUserWithPreviousMessage) || ((!isRightMessage && isSameUserWithPreviousMessage) && chatController.getChatTimeWithPrevious(currentMessage, previousMessage).isNotEmpty) ? ClipRRect(
              ...
              Flexible(child: Column(crossAxisAlignment: isRightMessage ? CrossAxisAlignment.end : CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                ...
                currentMessage.filesFullUrl != null && currentMessage.filesFullUrl!.isNotEmpty ? Column(crossAxisAlignment: isRightMessage ? CrossAxisAlignment.end : CrossAxisAlignment.start, children: [
                  ...
                  currentMessage.filesFullUrl!.isNotEmpty ? Directionality(
                    ...
                    child: SizedBox(
                      ...
                      child: _isVideo(currentMessage.filesFullUrl![0]) ? InkWell(
